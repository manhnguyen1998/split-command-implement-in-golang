...
func TestSplitFileByChunk(t *testing.T) {
	...
	err := SplitFileByChunk(inputPath, outputPathPrefix, chunkSize)
	if err != nil {
...
func TestSplitFileByLine(t *testing.T) {
	...
	err := SplitFileByLine(inputPath, outputPathPrefix, linesPerChunk)
	if err != nil {
		t.Errorf("Error splitting file: %v", err)
	}
...
func TestSplitFileByByte(t *testing.T) {
	...
	err := SplitFileByByte(inputPath, outputPathPrefix, option)
	if err != nil {
		t.Errorf("Error splitting file: %v", err)
	}
